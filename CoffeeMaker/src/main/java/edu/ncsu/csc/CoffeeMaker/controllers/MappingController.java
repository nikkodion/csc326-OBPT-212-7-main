...
public class MappingController {
    ...
    /**
     * On a GET request to /addcustomrecipe, the MakeCoffeeController will
     * return /src/main/resources/templates/addcustomrecipe.html.
     *
     * @param model
     *            underlying UI model
     * @return contents of the page
    ...
    public String addCustomRecipeForm ( final Model model ) {
